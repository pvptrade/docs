...
Spot fees only apply on sells, and fees for trading spot are the same as fees for trading perps multiplied by 5. For example, the trader in the example above would have a fee of **0.1%** for selling spot tokens.