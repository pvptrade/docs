...
Private keys are stored and encrypted by Turnkey, which was founded by the team that built Coinbase Custody. Only you have access to your private key as it is stored with Turnkey's verifiably secure enclaves. You can use the /security command to setup 2FA with biometric passkeys (Touch ID/Face ID). 
